...
if __name__ == "__main__":
    # Example usage
    mp4_file = r"C:\Users\black2\Videos\MEmu Video\D4DJ - tiktok meme (FULLHD + FULLSONG).webm"
    mp3_file = r"C:\Users\black2\Videos\MEmu Video\D4DJ - tiktok meme (FULLHD + FULLSONG).mp3"
